---
title: 海量数据面试题
date: 2019-06-07 20:16:27
categories:
- 收藏
---
[十道面试题与十个海量数据处理方法总结](https://www.cnblogs.com/btdxqz/p/6895068.html)
## 面试题
...
典型的Top K算法，还是在这篇文章里头有所阐述，详情请参见：[从头到尾彻底解析Hash表算法](https://blog.csdn.net/v_JULY_v/article/details/6256463)
...
下面的方法对海量数据的处理方法进行了一个一般性的总结，当然这些方法可能并不能完全覆盖所有的问题，但是这样的一些方法也基本可以处理绝大多数遇到的问题。下面的一些问题基本直接来源于公司的面试笔试题目，方法不一定最优，如果你有更好的处理方法，欢迎讨论。
